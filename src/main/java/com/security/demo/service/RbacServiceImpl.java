...
import com.security.demo.repository.SysPermissionRepository;
import com.security.demo.repository.SysUserRepository;
import com.security.demo.service.impl.RbacService;
...
public class RbacServiceImpl implements RbacService {
    @Autowired
    private SysPermissionRepository
            sysPermissionRepository;
    @Autowired
    private SysUserRepository sysUserRepository;
    private AntPathMatcher antPathMatcher = new
            AntPathMatcher();

    /**
     * 实现rbac模型接口 重写hasPermission用于判断当前用户的权限信息
...
//curds.add(sysPermission.getPermission() +sysPermission.getUrl());
                });
            }
